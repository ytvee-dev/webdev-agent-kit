...
- The user asks to change `AGENTS.md`, `README.md`, manifests, validators,
...
1. Classify the target layer: `AGENTS.md`, `README.md`, manifests, validators,
   `common/**`, `project/**`, or `skills/**`.
...
- "Update AGENTS.md, manifests, README, and graph links for renamed skills."
...
5. Use `references/documentation-maintenance.md` for graph, README, manifest, rename, or publication changes.
