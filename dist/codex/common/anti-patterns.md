...
- `common/anti-patterns/no-anonymous-functions.md` - use named components, handlers, and helpers.
...
- `common/anti-patterns/no-nested-array-pipelines.md` - avoid unreadable nested maps, filters, reduces, and inline transformations.
- `common/anti-patterns/no-component-loops.md` - do not prepare JSX with imperative loops or manual render arrays inside components.
- `common/anti-patterns/no-tests-for-components-or-functions.md` - do not create tests for components or functions.
