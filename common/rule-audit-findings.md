...
- Test infrastructure was previously conflated with existing-test maintenance. The current policy permits relevant existing tests and directly affected test updates for confirmed contract changes, while new tests require an explicit request and new tooling or broad suites remain approval-gated.
