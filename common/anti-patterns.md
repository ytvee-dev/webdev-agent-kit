...
- `common/anti-patterns/no-test-authoring-by-default.md` - do not create or edit tests unless the user explicitly asks and approves scope.
...
- Creating or editing tests unless the user explicitly asks for test authoring and approves the scope.
