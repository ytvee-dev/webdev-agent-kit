...
- Read repository policy and selected skill instructions before optimizing for token usage.
...
- Do not read `README.md` for runtime routing, planning, verification, bundle maintenance, or fallback context.
- Compress final output, not task understanding.

## Escalation

Increase context budget only when targeted inspection reveals unclear ownership, cross-module behavior, architecture risk, or conflicting evidence.
